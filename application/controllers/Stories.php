...
Name: Jovanni Elias
Final project
Purpose: This controller will talk to the model (my database). From there it will grab a table called stories.
**********************/
...
class Stories extends CI_Controller {
    ...
    public function index() {
        ...
        $temp['news']=$stories;
        $data['stories']=$this->parser->parse('templates/stories', $temp, TRUE);
