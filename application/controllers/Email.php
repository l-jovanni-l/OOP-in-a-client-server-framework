...
Name: Jovanni Elias
Final project
Purpose: This is the controller for when i submit a form. This will take my user input which i sent throught ajax
  *     Then it will validate all the inputs and send back a nice little response.
**********************/
